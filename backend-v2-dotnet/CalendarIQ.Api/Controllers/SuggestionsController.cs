...
public class SuggestionsController : ControllerBase
{
    ...
    public SuggestionsController(AppDbContext db, GroqClient groqClient)
    {
        _db = db;
    ...
    public async Task<IActionResult> GetAiSuggestions([FromBody] AiSuggestionRequest request)
    {
        ...
        var pastEvents = await _db.Events.Where(a => a.UserId == userId && a.Day >= twoMonthsAgo && a.Day <= selectedDateMs).OrderByDescending(e => e.Day).ToListAsync();
